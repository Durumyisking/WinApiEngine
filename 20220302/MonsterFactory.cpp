...
CMonster * CMonsterFactory::CreateMonster(MON_TYPE _eType, Vec2 _vPos, CRoom* _pRoom)
{
	...
	{
		pMon = new CBaby;
		Stat Stat = { 30, 30, 1, 30.f, 600.f, 1.5f ,0.f };
		pMon->SetScale(Vec2(64.f, 64.f));
		pMon->SetStat(Stat);
		pMon->SetRecogRange(300.f);
		pMon->SetPos(_vPos);
	...
	{
		pMon = new CKeeper;
		Stat Stat = { 20, 20, 1, 300.f, 400.f, 1.5f ,0.f };
		pMon->SetScale(Vec2(64.f, 64.f));
		pMon->SetStat(Stat);
		pMon->SetRecogRange(250.f);
		pMon->SetPos(_vPos);
		...
		pMon->CreateRigidBody();
		pMon->GetRigidBody()->SetMass(2.5f);
		pMon->GetRigidBody()->SetFricCoeff(700.f);
	...
	{
		pMon = new CPooter;
		Stat Stat = { 15, 15, 1, 100.f, 600.f, 1.5f ,0.f };
		pMon->SetScale(Vec2(32.f, 32.f));
		pMon->SetStat(Stat);
		pMon->SetRecogRange(300.f);
		pMon->SetPos(_vPos);
		...
		pMon->CreateRigidBody();
		pMon->GetRigidBody()->SetMass(1.f);
		pMon->GetRigidBody()->SetFricCoeff(100.f);
